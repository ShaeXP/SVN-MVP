...
import 'package:lashae_s_application/presentation/recording_ready_screen/initial_page.dart';
...
class AppPages {
  static final pages = <GetPage>[
    ...
    GetPage(
        ...
        page: () => const RecordingLibraryScreen()),
    GetPage(
        name: Routes.recordingSummaryScreen,
        page: () => const RecordingSummaryScreen()),
    GetPage(
        name: Routes.recordingReadyScreenInitialPage,
        page: () => const RecordingReadyInitialPage()),
